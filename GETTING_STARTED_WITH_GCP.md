...
You will be charged, immediately once you run out of free credit. It's highly recommended that one stop's the VM when it's not being utilized, as the charge per hour is ~$1. Approzimately you can get less than 300 hours with the free credit to play aroung with a GPU VM on GCP.
